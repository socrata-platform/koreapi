...
info = function () {
    ...
    ret['params'] = { domain: {class: "domain", default: "opendata.socrata.com"},
                      start: { class: "date", default: "2013-01-01"},
...
runAndWriteToFile = function () {
    if (domain_id == null || start == null || end == null) {
        ...
        tempFile.write("start, end," + metricNames.join(", ") + ", ave_js_load_time, ave_dom_load_time, ave_resp_read_time, ave_resp_start_time\n");
        for (var row = 0; row < metrics.length; row++) {
            ...
            newRow = newRow + render_time + ","  + dom_time;
            newRow = newRow + "\n"
